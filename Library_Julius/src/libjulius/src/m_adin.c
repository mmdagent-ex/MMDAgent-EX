...
adin_initialize(Recog *recog)
{
  ...
  if (sid >= 0) {
    ...
    adin->ad_standby 	   = (boolean (*)(int, void *, void *)) plugin_get_func(sid, "adin_standby");
    adin->ad_begin 	   = (boolean (*)(char *, void *)) plugin_get_func(sid, "adin_open");
    adin->ad_end 	   = (boolean (*)(void *)) plugin_get_func(sid, "adin_close");
    adin->ad_resume 	   = (boolean (*)(void *)) plugin_get_func(sid, "adin_resume");
    adin->ad_pause 	   = (boolean (*)(void *)) plugin_get_func(sid, "adin_pause");
    adin->ad_terminate 	   = (boolean (*)(void *)) plugin_get_func(sid, "adin_terminate");
    adin->ad_read 	   = (int (*)(SP16 *, int, void *)) plugin_get_func(sid, "adin_read");
    adin->ad_input_name	   = (char * (*)(void *)) plugin_get_func(sid, "adin_input_name");
