 ...
 */
boolean
adin_standby(int sfreq, void *dummy, void *data)
{
  /* store the frequency */
  freq = sfreq;
  return TRUE;
 ...
 */
boolean
adin_open(char *pathname, void *data)
{
  /* do open the device */
  int fmt;
  int stereo;
 ...
 */
int
adin_read(SP16 *buf, int sampnum, void *data)
{
  audio_buf_info info;
  int size, cnt;
