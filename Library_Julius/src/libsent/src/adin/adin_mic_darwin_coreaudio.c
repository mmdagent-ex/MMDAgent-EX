...
boolean adin_mic_standby(int sfreq, void* dummy, void *data) {
  OSStatus status;
  UInt32 propertySize;
...
boolean adin_mic_begin(char *pathname, void *data){ return TRUE; }
boolean adin_mic_end(void *data){ return TRUE; }

int adin_mic_read(void *buffer, int nsamples, void *data) {
  OSStatus status;
