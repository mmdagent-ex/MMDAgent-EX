 ...
 */
boolean
adin_netaudio_standby(int sfreq, void *arg, void *data)
{
 ...
 */
boolean
adin_netaudio_begin(char *pathname, void *data)
{
  NA_start();
  return(TRUE);
}
 ...
 */
int
adin_netaudio_read(SP16 *buf, int sampnum, void *data)
{
  int cnt;
 ...
 */
char *
adin_netaudio_input_name(void *data)
{
