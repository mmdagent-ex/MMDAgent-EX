 ...
 */
boolean
adin_file_standby(int freq, void *arg, void *data)
{
  char *fname = arg;
  if (fname != NULL) {
 ...
 */
boolean
adin_file_begin(char *filename, void *data)
{
  boolean readp;
 ...
 */
int
adin_file_read(SP16 *buf, int sampnum, void *data)
{
  FILE *fp;
  int cnt;
 ...
 */
boolean
adin_stdin_standby(int freq, void *arg, void *data)
{
  /* store sampling frequency */
  sfreq = freq;
  return(TRUE);
 ...
 */
boolean
adin_stdin_begin(char *pathname, void *data)
{
 ...
 */
int
adin_stdin_read(SP16 *buf, int sampnum, void *data)
{
  int cnt;
 ...
 */
char *
adin_file_get_current_filename(void *data)
{
 ...
 */
char *
adin_stdin_input_name(void *data)
{
  return("stdin");
}
