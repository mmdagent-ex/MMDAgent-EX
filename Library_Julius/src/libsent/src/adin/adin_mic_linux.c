 ...
 */
boolean
adin_mic_standby(int sfreq, void *dummy, void *data)
{
#if defined(HAS_ALSA)
  return(adin_alsa_standby(sfreq, dummy, data));
#elif defined(HAS_OSS)
  return(adin_oss_standby(sfreq, dummy, data));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_standby(sfreq, dummy, data));
#elif defined(HAS_ESD)
  return(adin_esd_standby(sfreq, dummy, data));
 ...
 */
boolean
adin_mic_begin(char *pathname, void *data)
{
#if defined(HAS_ALSA)
  return(adin_alsa_begin(pathname, data));
#elif defined(HAS_OSS)
  return(adin_oss_begin(pathname, data));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_begin(pathname, data));
#elif defined(HAS_ESD)
  return(adin_esd_begin(pathname, data));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return FALSE;
#endif
 ...
 */
boolean
adin_mic_end(void *data)
{
#if defined(HAS_ALSA)
  return(adin_alsa_end(data));
#elif defined(HAS_OSS)
  return(adin_oss_end(data));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_end(data));
#elif defined(HAS_ESD)
  return(adin_esd_end(data));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return FALSE;
#endif
 ...
 */
int
adin_mic_read(SP16 *buf, int sampnum, void *data)
{
#if defined(HAS_ALSA)
  return(adin_alsa_read(buf, sampnum, data));
#elif defined(HAS_OSS)
  return(adin_oss_read(buf, sampnum, data));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_read(buf, sampnum, data));
#elif defined(HAS_ESD)
  return(adin_esd_read(buf, sampnum, data));
#else  /* other than Linux */
  jlog("Error: neither of pulseaudio/alsa/oss/esd device is available\n");
  return -2;
#endif
 ...
 */
char *
adin_mic_input_name(void *data)
{
#if defined(HAS_ALSA)
  return(adin_alsa_input_name(data));
#elif defined(HAS_OSS)
  return(adin_oss_input_name(data));
#elif defined(HAS_PULSEAUDIO)
  return(adin_pulseaudio_input_name(data));
#elif defined(HAS_ESD)
  return(adin_esd_input_name(data));
#else  /* other than Linux */
