 ...
 */
boolean
adin_tcpip_standby(int freq, void *port_str, void *data)
{
  int port;
 ...
 */
boolean
adin_tcpip_begin(char *pathname, void *data)
{
#ifdef FORK_ADINNET
    /***********************************/
 ...
 */
int
adin_tcpip_read(SP16 *buf, int sampnum, void *data)
{
  int cnt, ret;
  fd_set rfds;
  struct timeval tv;
 ...
 */
boolean
adin_tcpip_send_pause(void *data)
{
   int count;
   char com;
 ...
 */
boolean
adin_tcpip_send_resume(void *data)
{
  int count;
  char com;
  int cnt;
 ...
 */
boolean
adin_tcpip_send_terminate(void *data)
{
   int count;
   char com;
 ...
 */
char *
adin_tcpip_input_name(void *data)
{
