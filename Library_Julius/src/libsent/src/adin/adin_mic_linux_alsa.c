 ...
 */
boolean
adin_alsa_standby(int sfreq, void *dummy, void *data)
{
#ifndef HAS_ALSA
 ...
 */
boolean
adin_alsa_begin(char *pathname, void *data)
{
#ifndef HAS_ALSA
  return FALSE;
#else
 ...
 */
int
adin_alsa_read(SP16 *buf, int sampnum, void *data)
{
#ifndef HAS_ALSA
  return -2;
#else
 ...
 */
char *
adin_alsa_input_name(void *data)
{
#ifndef HAS_ALSA
  return NULL;
#else
