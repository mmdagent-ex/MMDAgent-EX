 ...
 */
boolean
adin_pulseaudio_standby(int sfreq, void *dummy, void *data)
{
 ...
 */
boolean
adin_pulseaudio_begin(char *arg, void *data)
{
#ifndef HAS_PULSEAUDIO
  jlog("Error: PulseAudio not compiled in\n");
  return FALSE;
 ...
 */
int
adin_pulseaudio_read(SP16 *buf, int sampnum, void *data)
{
#ifndef HAS_PULSEAUDIO
  return -2;
#else
 ...
 */
char *
adin_pulseaudio_input_name(void *data)
{
#ifndef HAS_PULSEAUDIO
  return NULL;
#else
