 ...
 */
boolean
adin_oss_standby(int sfreq, void *dummy, void *data)
{
#ifndef HAS_OSS
 ...
 */
boolean
adin_oss_begin(char *pathname, void *data)
{
  char buf[4];
  char *p;
  size_t ret;
 ...
 */
int
adin_oss_read(SP16 *buf, int sampnum, void *data)
{
#ifndef HAS_OSS
  return -2;
#else
