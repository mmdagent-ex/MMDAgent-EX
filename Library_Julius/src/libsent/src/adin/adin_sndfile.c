 ...
 */
boolean
adin_sndfile_standby(int freq, void *arg, void *data)
{
  char *fname = arg;
  if (fname != NULL) {
 ...
 */
boolean
adin_sndfile_begin(char *filename, void *data)
{
  boolean readp;
 ...
 */
int
adin_sndfile_read(SP16 *buf, int sampnum, void *data)
{
  int cnt;
 ...
 */
char *
adin_sndfile_get_current_filename(void *data)
{
