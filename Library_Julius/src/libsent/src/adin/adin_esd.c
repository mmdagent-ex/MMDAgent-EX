 ...
 */
boolean
adin_esd_standby(int sfreq, void *dummy, void *data)
{
#ifndef HAS_ESD
 ...
 */
boolean
adin_esd_begin(char *pathname, void *data)
{
  return(TRUE);
}
 ...
 */
int
adin_esd_read(SP16 *buf, int sampnum, void *data)
{
#ifndef HAS_ESD
  return -2;
#else
