...
/* adin/adin_mic_*.c */
boolean adin_mic_standby(int freq, void *arg, void *data);
boolean adin_mic_begin(char *pathname, void *data);
boolean adin_mic_end(void *data);
int adin_mic_read(SP16 *buf, int sampnum, void *data);
boolean adin_mic_pause(void *data);
boolean adin_mic_terminate(void *data);
boolean adin_mic_resume(void *data);
char *adin_mic_input_name(void *data);
/* adin/adin_mic_linux_alsa.c */
boolean adin_alsa_standby(int freq, void *arg, void *data);
boolean adin_alsa_begin(char *pathname, void *data);
boolean adin_alsa_end(void *data);
int adin_alsa_read(SP16 *buf, int sampnum, void *data);
char *adin_alsa_input_name(void *data);
/* adin/adin_mic_linux_oss.c */
boolean adin_oss_standby(int freq, void *arg, void *data);
boolean adin_oss_begin(char *pathname, void *data);
boolean adin_oss_end(void *data);
int adin_oss_read(SP16 *buf, int sampnum, void *data);
char *adin_oss_input_name(void *data);
/* adin/adin_esd.c */
boolean adin_esd_standby(int freq, void *arg, void *data);
boolean adin_esd_begin(char *pathname, void *data);
boolean adin_esd_end(void *data);
int adin_esd_read(SP16 *buf, int sampnum, void *data);
char *adin_esd_input_name(void *data);
/* adin/adin_pulseaudio.c */
boolean adin_pulseaudio_standby(int freq, void *arg, void *data);
boolean adin_pulseaudio_begin(char *pathname, void *data);
boolean adin_pulseaudio_end(void *data);
int adin_pulseaudio_read(SP16 *buf, int sampnum, void *data);
char *adin_pulseaudio_input_name(void *data);
/* adin/adin_netaudio.c  and adin/adin_na.c */
boolean adin_netaudio_standby(int freq, void *arg, void *data);
boolean adin_netaudio_begin(char *pathname, void *data);
boolean adin_netaudio_end(void *data);
int adin_netaudio_read(SP16 *buf, int sampnum, void *data);
char *adin_netaudio_input_name(void *data);
int NA_standby(int, char *, void *);
void NA_start(void *);
void NA_stop(void *);
int NA_read(SP16 *buf, int sampnum, void *);

/* adin/adin_file.c */
boolean adin_file_standby(int freq, void *arg, void *data);
boolean adin_file_begin(char *pathname, void *data);
int adin_file_read(SP16 *buf, int sampnum, void *data);
boolean adin_file_end(void *data);
boolean adin_stdin_standby(int freq, void *arg, void *data);
boolean adin_stdin_begin(char *pathname, void *data);
int adin_stdin_read(SP16 *buf, int sampnum, void *data);
char *adin_file_get_current_filename(void *data);
char *adin_stdin_input_name(void *data);

/* adin/adin_sndfile.c */
#ifdef HAVE_LIBSNDFILE
boolean adin_sndfile_standby(int freq, void *arg, void *data);
boolean adin_sndfile_begin(char *pathname, void *data);
int adin_sndfile_read(SP16 *buf, int sampnum, void *data);
boolean adin_sndfile_end(void *data);
char *adin_sndfile_get_current_filename(void *data);
#endif

/* adin/adin_tcpip.c */
boolean adin_tcpip_standby(int freq, void *arg, void *data);
boolean adin_tcpip_begin(char *pathname, void *data);
boolean adin_tcpip_end(void *data);
int adin_tcpip_read(SP16 *buf, int sampnum, void *data);
boolean adin_tcpip_send_pause(void *data);
boolean adin_tcpip_send_terminate(void *data);
boolean adin_tcpip_send_resume(void *data);
char *adin_tcpip_input_name(void *data);
